...
export default function Home() {
  return (
    <>
      ...
      {/* ═══ HERO ═══ */}
      <section id="hero" className="relative min-h-[80vh] flex items-center justify-center pt-16 mt-[-64px] pb-16">
          ...
          <div className="max-w-2xl py-8">
            <div className="animate-fade-in-up">
              ...
              <p className="mt-8 text-sm md:text-base leading-relaxed text-white/80 max-w-md drop-shadow-sm">
                Construyendo soluciones sólidas desde la base de datos hasta el despliegue. Estudiante de Ingeniería Informática enfocado en automatización e infraestructura.
              </p>
              
              <div className="flex items-center gap-4 mt-6 pointer-events-auto">
                <a href="https://github.com/Pato-deve" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors duration-300">
                ...
                <a href="https://www.linkedin.com/in/patriciomartinez-web" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors duration-300">
            ...
            <div className="animate-slide-in-right delay-300 pointer-events-auto mt-8">
              <div className="flex items-center gap-3 text-white/60">
                ...
                <span className="text-xs tracking-wide font-medium">Buenos Aires, Argentina</span>
              </div>
            </div>
          </div>
        </div>
